...
extern "C"
{
    ...
    typedef struct
    {
        ...
        AX_U32 nBgColor;
        AX_IVPS_ASPECT_RATIO_ALIGN_E eAligns[2];
        AX_IVPS_RECT_T tRect;
    } AX_IVPS_ASPECT_RATIO_T;

    typedef enum
    {
        AX_IVPS_ENGINE_SUBSIDIARY = 0,
        AX_IVPS_ENGINE_TDP,
        AX_IVPS_ENGINE_GDC,
        AX_IVPS_ENGINE_VPP,
        AX_IVPS_ENGINE_VGP,
...
#define AX_IVPS_REGION_MAX_DISP_NUM (32)
    ...
    {
        AX_S32 nZindex;
        AX_BOOL bSingleCanvas;
        AX_U16 nAlpha;
        AX_IMG_FORMAT_E eFormat;
        AX_BITCOLOR_T nBitColor;
